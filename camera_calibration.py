...
markerSeparation = .5   # Here, measurement unit is centimetre.
    ...
    for im in img_list:
        ...
        if(len(corners) == 20):
            if first == True:
                ...
                print('0. Shapes: {}'.format(len(corners_list)))
                id_list = ids
                first = False
            else:
                print('1. Shapes: {} and {}'.format(len(corners_list), len(corners)))
